...
| Montgomery | Prothonotary case search (PSI) | User-assisted | "Validating" human-verification challenge |
...
| Delaware | Real Estate & Tax Records portal (Site Information, Residential/Commercial, Owner History, Tax Sale Information, Delinquent Tax) | User-assisted | Disclaimer agreement with reCAPTCHA hooks. The daily refresh creates re-capture tasks, and old status is shown as stale. |
